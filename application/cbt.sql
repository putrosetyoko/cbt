...
(23, '654125486585452156', 'Putro Setyoko', 'putro@smpicsamarinda.sch.id');
...
--
-- Dumping data for table `guru_mapel_kelas_ajaran`
--

INSERT INTO `guru_mapel_kelas_ajaran` (`id_gmka`, `guru_id`, `mapel_id`, `kelas_id`, `id_tahun_ajaran`) VALUES
(106, 19, 9, 8, 1),
(117, 23, 9, 3, 1);
...
(0, 'KH. Abul Hasan', 15),
(1, 'KH. Abdur Rasyid', 15),
(2, 'KH. Abdullah Marisie', 15),
(3, 'Takhasus', 15),
(4, 'KH. Sabranity', 16),
(5, 'KH. Abdul Ghalib Karim', 16),
(6, 'KH. Djuhaifah Thalib', 18),
(7, 'KH. Asli Husaini', 18),
(8, 'KH. Abdul Sani Karim', 18);
...
--
-- Dumping data for table `penanggung_jawab_soal_ajaran`
--

INSERT INTO `penanggung_jawab_soal_ajaran` (`id_pjsa`, `mapel_id`, `guru_id`, `id_tahun_ajaran`, `keterangan`, `ditetapkan_pada`) VALUES
(9, 9, 19, 1, '', '2025-06-01 12:45:59');
...
(13, '124563076', 'Aira Nur Malika Putri', 'Laki-laki');
...
--
-- Dumping data for table `siswa_kelas_ajaran`
--

INSERT INTO `siswa_kelas_ajaran` (`id_ska`, `siswa_id`, `kelas_id`, `id_tahun_ajaran`) VALUES
(30, 12, 8, 1);
...
(1, '2025/2026 Ganjil', 'Ganjil', '2025-07-14', '2025-12-20', 'aktif', '2025-05-30 09:50:03', '2025-06-01 14:42:10');
...
INSERT INTO `tb_soal` (`id_soal`, `mapel_id`, `id_jenjang`, `guru_id`, `soal`, `file`, `tipe_file`, `opsi_a`, `opsi_b`, `opsi_c`, `opsi_d`, `opsi_e`, `file_a`, `file_b`, `file_c`, `file_d`, `file_e`, `jawaban`, `gambar`, `created_on`, `updated_on`, `bobot`) VALUES
(4, 9, 15, 19, '<p>1 + 1 =</p>', NULL, NULL, '<p>2</p>', '<p>3</p>', '<p>4</p>', '<p>5</p>', '<p>6</p>', NULL, NULL, NULL, NULL, NULL, 'A', NULL, 1748842689, 1748842689, 1);
...
(3, 0x3a3a31, 'admin', '$2y$12$WItqyPN6/Mz8ZJoSdx7QtuWujT3xoaNarIhgAxZmg4W8OnlisNTJW', 'admin@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1748521982, 1748848665, 1, 'Super', 'Admin', NULL, NULL),
(83, 0x3a3a31, 'anggi@smpicsamarinda.sch.id', '$2y$10$zb6/3WLGWdTd7rnAUuG.TO5zgy60bf9LFOO7HCHVnUk3EOefB3MxC', 'anggi@smpicsamarinda.sch.id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1748842412, 1748848759, 1, 'Anggi', 'Aisyadatina, M.Pd.', NULL, NULL),
(84, 0x3a3a31, 'putro@smpicsamarinda.sch.id', '$2y$10$nn4j6vskpUR9M9NPvKvpDOHxfuzQ1JYT7TquEzBOAYW./eKD3zCu2', 'putro@smpicsamarinda.sch.id', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1748842412, 1748848732, 1, 'Putro', 'Setyoko', NULL, NULL);
...
--
ALTER TABLE `d_ujian_soal`
  MODIFY `id_d_ujian_soal` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `guru_mapel_kelas_ajaran`
  MODIFY `id_gmka` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `tb_soal`
  MODIFY `id_soal` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
