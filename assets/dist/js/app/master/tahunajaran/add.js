$(document).ready(function () {
  ...
  // Inisialisasi datepicker (jika belum ada di add.php atau ingin dipusatkan di sini)
  // Jika sudah ada di add.php, baris ini bisa dihilangkan dari add_tahunajaran.js
